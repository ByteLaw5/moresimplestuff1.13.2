...
public class RenderIceGhastProjectile extends Render<EntityIceGhastProjectile> {
	private float scale = 1.0f;
	private static final ResourceLocation TEXTURES = new ResourceLocation(Main.modid, "textures/entity/ice_proj.png");
	
	public RenderIceGhastProjectile(RenderManager manager) {
		super(manager);
	}
	
	@Override
	public void doRender(EntityIceGhastProjectile entity, double x, double y, double z, float entityYaw,
			float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityIceGhastProjectile entity) {
		return TEXTURES;
	}
}
